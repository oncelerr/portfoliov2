...
export function Nav() {
  ...
  const isHome = location.pathname === "/site" || location.pathname === "/";
      ...
      >
        ...
        <ul className="hidden items-center gap-1 md:flex">
          {nav.map((item) => {
            ...
            const href = isHome ? item.href : `/site${item.href}`;
            return (
              <li key={item.href}>
                <a
                  href={href}
        ...
        <div id="mobile-nav" className="border-t border-border-subtle bg-surface-0 px-4 pb-4 md:hidden">
          <ul className="flex flex-col gap-1 pt-2">
            {nav.map((item) => (
              <li key={item.href}>
                <a
                  href={isHome ? item.href : `/site${item.href}`}
